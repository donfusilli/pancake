...
class Paint extends JFrame implements ActionListener, ChangeListener {
	...
	final String defTitle = "Draw a Pancake!";
	/** Last used file. */
	File lastUsedFile;
	/** Default file name to save to. */
	final String defFileName = "pancake.png";
	...
	public void setMousePosition(int x, int y) {
		...
		mousePositionLabel.setText(str);
	}
	...
	public void stateChanged(ChangeEvent e) {
		...
		if (s == toolSizeSlider) {
			...
			String str = "Tool Size: " + canvas.getToolSize();
			toolSizeLabel.setText(str);
		}
		else {
	...
	private void updateSizeLabel() {
		String str = "Image: " + lastImgWidth + " x " + lastImgHeight;
